...
for example, if some methods does rollouts, I would be interested in what format does it accept states (are they batched, for instance), how it accepts agents (can it run different agents for different states in batch, e.g.), what it returns, etc
