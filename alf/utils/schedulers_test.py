...
class CyclicalSchedulerTest(parameterized.TestCase, unittest.TestCase):
    ...
    def test_step_switch_iterations(
        ...
        effective_half_cycle_size = (
            ...
            else half_cycle_size * max(num_iterations, num_env_steps)
        )
        ...
        if switch_mode == "step":
            ...
            if effective_half_cycle_size == 1:
                ...
                expected_values = [0.0, 0.5, 1, 0.5, 0.0, 0.5, 1, 0.5, 0.0, 0.5]
            elif effective_half_cycle_size == 3:
                expected_values = [
                    0.0,
                    0.3333333333333333,
    ...
    def test_step_switch_iterations_upper_bound_as_base(
        ...
        if switch_mode == "step":
            ...
            if effective_half_cycle_size == 1:
                ...
                expected_values = [1.0, 0.5, 0, 0.5, 1.0, 0.5, 0, 0.5, 1.0, 0.5]
            elif effective_half_cycle_size == 3:
                expected_values = [
                    1.0,
                    0.6666666666666667,
