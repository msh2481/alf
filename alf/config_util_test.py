...
class ConfigTest(alf.test.TestCase):
    ...
    def test_config1(self):
        ...
        self.assertRaisesRegex(
            ValueError, "test.b' has already been used", alf.config, {"test.b": None}
        )
        ...
        self.assertRaisesRegex(
            ValueError, "config name 'test_f.a' is ambiguous", alf.validate_pre_configs
        )
    ...
    def test_sole_config(self):
        ...
        alf.config(
            "override_on_immutable_and_sole_init", x=0, sole_init=True, mutable=False
        )
