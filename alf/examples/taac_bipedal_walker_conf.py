...
from alf.algorithms.taac_algorithm import (
    TaacAlgorithm,
    TaacLAlgorithm,
    TaacQAlgorithm,
)
...
critic_network_cls = partial(CriticNetwork, joint_fc_layer_params=hidden_layers)
...
alf.config(
    ...
    target_entropy=(
        partial(dist_utils.calc_default_target_entropy, min_prob=0.05),
        partial(dist_utils.calc_default_target_entropy, min_prob=0.1),
    ),
)
