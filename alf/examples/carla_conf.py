...
def create_input_preprocessors(encoding_dim, use_bn=False, preproc_bn=False):
    ...
    def _make_simple_preproc(spec, use_bias=False):
        return torch.nn.Sequential(
            ...
            alf.layers.FC(
                spec.numel, encoding_dim, use_bias=use_bias, use_bn=preproc_bn
            ),
        )
    ...
    return {
        ...
        "prev_action": _make_simple_preproc(
            prev_action_spec, use_bias="camera" not in observation_spec["observation"]
        ),
    }
