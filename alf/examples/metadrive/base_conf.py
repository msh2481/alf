...
alf.config(
    "create_environment", env_load_fn=suite_metadrive.load, num_parallel_environments=12
)
...
alf.config(
    ...
    lon_jerk_cost_func=partial(
        squared_jerk_cost, jerk_deadband=4.0, speed_deadband=1.5, scale=1e-3, cap=0.8
    ),
