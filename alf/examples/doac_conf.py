...
from alf.networks import ActorDistributionNetwork, CriticNetwork, CriticQuantileNetwork
...
if dmc_tasks:
    ...
    alf.config(
        "create_environment", env_name="HalfCheetah-v3", num_parallel_environments=1
    )
    if use_epistemic_alpha:
        alpha_optimizer = None
