...
class EncodingNetworkTest(parameterized.TestCase, alf.test.TestCase):
    ...
    def test_image_decoding_network(self, preprocessing_fc_layers, same_padding):
        ...
        network = ImageDecodingNetwork(
            ...
            transconv_layer_params=((16, (2, 2), 1, (1, 0)), (64, 3, (1, 2), 0)),
    ...
    def test_encoding_network_nonimg(
        self, use_batch_ensemble, last_layer_size, last_activation, output_tensor_spec
    ):
        input_spec = TensorSpec((100,), torch.float32)
        embedding = input_spec.zeros(outer_dims=(1,))
    ...
    @parameterized.parameters((True,), (False,))
    def test_encoding_network_input_preprocessor(self, input_with_ensemble_ids):
    ...
    def test_encoding_network_nested_input(self, lstm):
        ...
        input_preprocessors = dict(
            a=EmbeddingPreprocessor(
                input_spec["a"], conv_layer_params=((1, 2, 2, 0),), embedding_dim=100
            ),
            b=[
