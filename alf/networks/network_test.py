...
def test_net_copy(net):
    ...
    for n, p in new_params.items():
        ...
        assert id(p) != id(params[n]), (
            "The parameter of the copied parameter "
...
class MockNetwork(BaseNetwork):
    ...
    def __init__(self, param1, param2, kwarg1=2, kwarg2=3):
        ...
        self.var1 = nn.Parameter(torch.tensor(1.0, requires_grad=False))
        self.var2 = nn.Parameter(torch.tensor(2.0, requires_grad=True))
...
class NetworkWrapperTest(alf.test.TestCase):
    ...
    def test_network_wrapper(self):
        ...
        self.assertEqual(pnet1.state_spec, TensorSpec((4,) + input_spec.shape))
