...
def get_metrics_from_eval_tfevents(eval_dir):
    ...
    logging.info(
        "Episode returns, %s, episode lengths: %s", episode_returns, episode_lengths
    )
...
class TrainPlayTest(alf.test.TestCase):
    ...
    def test_ddpg_pendulum(self):
        ...
        self._test(conf_file="ddpg_pendulum_conf.py", test_perf_func=_test_func)
    ...
    def test_diayn_pendulum(self):
        self._test(
            conf_file="diayn_pendulum.gin", extra_train_params=OFF_POLICY_TRAIN_PARAMS
        )
    ...
    def test_icm_mountain_car(self):
        self._test(
            conf_file="icm_mountain_car.gin", extra_train_params=ON_POLICY_TRAIN_PARAMS
        )
    ...
    def test_mbrl_pendulum(self):
        self._test(
            conf_file="mbrl_pendulum_conf.py", extra_train_params=MBRL_TRAIN_PARAMS
        )
    ...
    def test_mdq_pendulum(self):
        self._test(
            conf_file="mdq_pendulum.gin", extra_train_params=OFF_POLICY_TRAIN_PARAMS
        )
    ...
    def test_muzero_tic_tac_toe(self):
        self._test(
            conf_file="muzero_tic_tac_toe.gin", extra_train_params=MUZERO_TRAIN_PARAMS
        )

    def test_muzero_pendulum(self):
        self._test(
            conf_file="muzero_pendulum_conf.py", extra_train_params=MUZERO_TRAIN_PARAMS
        )
    ...
    def test_ppo_cart_pole(self):
        ...
        self._test(conf_file="ppo_cart_pole_conf.py", test_perf_func=_test_func)
    ...
    def test_sac_pendulum_latent_actor(self):
        ...
        self._test(
            conf_file="sac_pendulum_latent_actor_conf.py", test_perf_func=_test_func
        )
    ...
    def test_sarsa_pendulum(self):
        self._test(
            conf_file="sarsa_pendulum.gin", extra_train_params=ON_POLICY_TRAIN_PARAMS
        )
